	...
	public static class AttachmentUtils {
		...
		public static class ChunkSampleSiteMapUtil {
			...
			public static boolean isSurface(ChunkSampleSiteMap chunkSampleSiteMap, BlockPos blockPos) {
				return chunkSampleSiteMap.surfacePos().equals(blockPos);
			}
			 ...
			 * @return {@code true} if the given {@link BlockPos} matches the surface position of the given {@link ChunkSampleSiteMap}
			 * and the block state at the given {@link BlockPos} matches the surface state of the given {@link ChunkSampleSiteMap}
			 */
			public static boolean isSurface(ChunkSampleSiteMap chunkSampleSiteMap, BlockPos blockPos,
			                                          Level level)
			{
				return chunkSampleSiteMap.surfacePos().equals(blockPos) && chunkSampleSiteMap.surfaceState().equals(
					level.getBlockState(blockPos));
			}
			
			/**
			 * Determines if the given {@link BlockPos} matches the deep position of the given {@link ChunkSampleSiteMap}.
			 * But only checks the position, not the state.
			 *
			 * @param chunkSampleSiteMap the {@link ChunkSampleSiteMap} to check
			 * @param blockPos the {@link BlockPos} to check
			 * @return {@code true} if the given {@link BlockPos} matches the deep position of the given {@link ChunkSampleSiteMap}
			 */
			public static boolean isDeep(ChunkSampleSiteMap chunkSampleSiteMap, BlockPos blockPos) {
				return chunkSampleSiteMap.deepPos().equals(blockPos);
			}
			 ...
			 * @param level the {@link Level} to access the block state
			 * @return {@code true} if the given {@link BlockPos} matches the deep position of the given {@link ChunkSampleSiteMap}
			 * and the block state at the given {@link BlockPos} matches the deep state of the given {@link ChunkSampleSiteMap}
			 */
			public static boolean isDeep(ChunkSampleSiteMap chunkSampleSiteMap, BlockPos blockPos, Level level) {
				return chunkSampleSiteMap.deepPos().equals(blockPos) && chunkSampleSiteMap.deepState().equals(
					level.getBlockState(blockPos));
			}
			 ...
			 * @param chunkSampleSiteMap the {@link ChunkSampleSiteMap} to check
			 * @param blockPos the {@link BlockPos} to check
			 * @return {@code true} if the given {@link BlockPos} matches either the surface or deep position of the given
			 */
			 ...
			 * @param level the {@link Level} to access the block state
			 * @return {@code true} if the given {@link BlockPos} matches either the surface or deep position of the given
			 * {@link ChunkSampleSiteMap} and the block state at the given {@link BlockPos} matches either the surface or deep state
