...
public class PlacedFeatures {
	...
	public static void bootstrap(BootstrapContext<PlacedFeature> context) {
		...
		register(context, TITANIUM_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_TITANIUM_ORE_KEY),
		...
		register(context, COBALT_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_COBALT_ORE_KEY),
		...
		register(context, NICKEL_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_NICKEL_ORE_KEY),
		         OrePlacement.commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.absolute(-40),
		                                                                          VerticalAnchor.absolute(60))));
		register(context, PLATINUM_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_PLATINUM_ORE_KEY),
		...
		register(context, BAUXITE_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_BAUXITE_ORE_KEY),
		         OrePlacement.commonOrePlacement(3, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64),
		                                                                         VerticalAnchor.absolute(80))));
		register(context, MOLYBDENUM_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_MOLYBDENUM_ORE_KEY),
		...
		register(context, LITHIUM_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_LITHIUM_ORE_KEY),
		...
		register(context, IRIDIUM_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_IRIDIUM_ORE_KEY),
		         OrePlacement.rareOrePlacement(10, HeightRangePlacement.uniform(VerticalAnchor.absolute(-60),
		                                                                        VerticalAnchor.absolute(30))));
		register(context, GRAPHITE_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_GRAPHITE_ORE_KEY),
		         OrePlacement.commonOrePlacement(1, HeightRangePlacement.triangle(VerticalAnchor.absolute(-64),
		                                                                          VerticalAnchor.absolute(64))));
		register(context, BERYLLIUM_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_BERYLLIUM_ORE_KEY),
		         OrePlacement.commonOrePlacement(3, HeightRangePlacement.uniform(VerticalAnchor.absolute(-10),
		                                                                         VerticalAnchor.absolute(40))));
		register(context, CADMIUM_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_CADMIUM_ORE_KEY),
		...
		register(context, CHROMIUM_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_CHROMIUM_ORE_KEY),
		         OrePlacement.commonOrePlacement(3, HeightRangePlacement.uniform(VerticalAnchor.absolute(10),
		                                                                         VerticalAnchor.absolute(60))));
		register(context, MANGANESE_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_MANGANESE_ORE_KEY),
		...
		register(context, OSMIUM_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_OSMIUM_ORE_KEY),
		         OrePlacement.rareOrePlacement(12, HeightRangePlacement.triangle(VerticalAnchor.absolute(-40),
		                                                                         VerticalAnchor.absolute(10))));
		register(context, PALLADIUM_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_PALLADIUM_ORE_KEY),
		...
		register(context, THORIUM_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_THORIUM_ORE_KEY),
		...
		register(context, URANIUM_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_URANIUM_ORE_KEY),
		         OrePlacement.rareOrePlacement(8, HeightRangePlacement.triangle(VerticalAnchor.absolute(-30),
		                                                                        VerticalAnchor.absolute(30))));
		register(context, VANADIUM_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_VANADIUM_ORE_KEY),
		...
		register(context, ZINC_ORE_PLACED_KEY,
		         configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_ZINC_ORE_KEY),
	...
	private static ResourceKey<PlacedFeature> registerKey(String name) {
		return ResourceKey.create(Registries.PLACED_FEATURE,
		                          ResourceLocation.fromNamespaceAndPath(MOD_ID, name + "_placed"));
	}
