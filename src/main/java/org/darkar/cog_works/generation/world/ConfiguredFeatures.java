...
public class ConfiguredFeatures {
	...
	public static final ResourceKey<ConfiguredFeature<?, ?>> OVERWORLD_MOLYBDENUM_ORE_KEY = registerKey(
		"molybdenum_ore");
	...
	public static final ResourceKey<ConfiguredFeature<?, ?>> OVERWORLD_BERYLLIUM_ORE_KEY = registerKey(
		"beryllium_ore");
	...
	public static final ResourceKey<ConfiguredFeature<?, ?>> OVERWORLD_MANGANESE_ORE_KEY = registerKey(
		"manganese_ore");
	public static final ResourceKey<ConfiguredFeature<?, ?>> OVERWORLD_OSMIUM_ORE_KEY = registerKey("osmium_ore");
	public static final ResourceKey<ConfiguredFeature<?, ?>> OVERWORLD_PALLADIUM_ORE_KEY = registerKey(
		"palladium_ore");
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		List<OreConfiguration.TargetBlockState> overworldTungstenOres = List.of(
			OreConfiguration.target(stoneReplaceTest, Registry.Blocks.TUNGSTEN_ORE
				.get()
				.defaultBlockState()), OreConfiguration.target(deepslateReplaceTest,
			                                                   Registry.Blocks.DEEPSLATE_TUNGSTEN_ORE
				                                                   .get()
				                                                   .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldTitaniumOres = List.of(
			OreConfiguration.target(stoneReplaceTest, Registry.Blocks.TITANIUM_ORE
				.get()
				.defaultBlockState()), OreConfiguration.target(deepslateReplaceTest,
			                                                   Registry.Blocks.DEEPSLATE_TITANIUM_ORE
				                                                   .get()
				                                                   .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldCobaltOres = List.of(OreConfiguration.target(stoneReplaceTest,
		                                                                                              Registry.Blocks.COBALT_ORE
			                                                                                              .get()
			                                                                                              .defaultBlockState()),
		                                                                      OreConfiguration.target(
			                                                                      deepslateReplaceTest,
			                                                                      Registry.Blocks.DEEPSLATE_COBALT_ORE
				                                                                      .get()
				                                                                      .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldNickelOres = List.of(OreConfiguration.target(stoneReplaceTest,
		                                                                                              Registry.Blocks.NICKEL_ORE
			                                                                                              .get()
			                                                                                              .defaultBlockState()),
		                                                                      OreConfiguration.target(
			                                                                      deepslateReplaceTest,
			                                                                      Registry.Blocks.DEEPSLATE_NICKEL_ORE
				                                                                      .get()
				                                                                      .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldPlatinumOres = List.of(
			OreConfiguration.target(stoneReplaceTest, Registry.Blocks.PLATINUM_ORE
				.get()
				.defaultBlockState()), OreConfiguration.target(deepslateReplaceTest,
			                                                   Registry.Blocks.DEEPSLATE_PLATINUM_ORE
				                                                   .get()
				                                                   .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldBauxiteOres =
			List.of(OreConfiguration.target(stoneReplaceTest,
		                                                                                               Registry.Blocks.BAUXITE_ORE
			                                                                                               .get()
			                                                                                               .defaultBlockState()),
		                                                                       OreConfiguration.target(
			                                                                       deepslateReplaceTest,
			                                                                       Registry.Blocks.DEEPSLATE_BAUXITE_ORE
				                                                                       .get()
				                                                                       .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldMolybdenumOres = List.of(
			OreConfiguration.target(stoneReplaceTest, Registry.Blocks.MOLYBDENUM_ORE
				.get()
				.defaultBlockState()), OreConfiguration.target(deepslateReplaceTest,
			                                                   Registry.Blocks.DEEPSLATE_MOLYBDENUM_ORE
				                                                   .get()
				                                                   .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldLithiumOres =
			List.of(OreConfiguration.target(stoneReplaceTest,
		                                                                                               Registry.Blocks.LITHIUM_ORE
			                                                                                               .get()
			                                                                                               .defaultBlockState()),
		                                                                       OreConfiguration.target(
			                                                                       deepslateReplaceTest,
			                                                                       Registry.Blocks.DEEPSLATE_LITHIUM_ORE
				                                                                       .get()
				                                                                       .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldIridiumOres =
			List.of(OreConfiguration.target(stoneReplaceTest,
		                                                                                               Registry.Blocks.IRIDIUM_ORE
			                                                                                               .get()
			                                                                                               .defaultBlockState()),
		                                                                       OreConfiguration.target(
			                                                                       deepslateReplaceTest,
			                                                                       Registry.Blocks.DEEPSLATE_IRIDIUM_ORE
				                                                                       .get()
				                                                                       .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldGraphiteOres = List.of(
			OreConfiguration.target(stoneReplaceTest, Registry.Blocks.GRAPHITE_ORE
				.get()
				.defaultBlockState()), OreConfiguration.target(deepslateReplaceTest,
			                                                   Registry.Blocks.DEEPSLATE_GRAPHITE_ORE
				                                                   .get()
				                                                   .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldBerylliumOres = List.of(
			OreConfiguration.target(stoneReplaceTest, Registry.Blocks.BERYLLIUM_ORE
				.get()
				.defaultBlockState()), OreConfiguration.target(deepslateReplaceTest,
			                                                   Registry.Blocks.DEEPSLATE_BERYLLIUM_ORE
				                                                   .get()
				                                                   .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldCadmiumOres =
			List.of(OreConfiguration.target(stoneReplaceTest,
		                                                                                               Registry.Blocks.CADMIUM_ORE
			                                                                                               .get()
			                                                                                               .defaultBlockState()),
		                                                                       OreConfiguration.target(
			                                                                       deepslateReplaceTest,
			                                                                       Registry.Blocks.DEEPSLATE_CADMIUM_ORE
				                                                                       .get()
				                                                                       .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldChromiumOres = List.of(
			OreConfiguration.target(stoneReplaceTest, Registry.Blocks.CHROMIUM_ORE
				.get()
				.defaultBlockState()), OreConfiguration.target(deepslateReplaceTest,
			                                                   Registry.Blocks.DEEPSLATE_CHROMIUM_ORE
				                                                   .get()
				                                                   .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldManganeseOres = List.of(
			OreConfiguration.target(stoneReplaceTest, Registry.Blocks.MANGANESE_ORE
				.get()
				.defaultBlockState()), OreConfiguration.target(deepslateReplaceTest,
			                                                   Registry.Blocks.DEEPSLATE_MANGANESE_ORE
				                                                   .get()
				                                                   .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldOsmiumOres = List.of(OreConfiguration.target(stoneReplaceTest,
		                                                                                              Registry.Blocks.OSMIUM_ORE
			                                                                                              .get()
			                                                                                              .defaultBlockState()),
		                                                                      OreConfiguration.target(
			                                                                      deepslateReplaceTest,
			                                                                      Registry.Blocks.DEEPSLATE_OSMIUM_ORE
				                                                                      .get()
				                                                                      .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldPalladiumOres = List.of(
			OreConfiguration.target(stoneReplaceTest, Registry.Blocks.PALLADIUM_ORE
				.get()
				.defaultBlockState()), OreConfiguration.target(deepslateReplaceTest,
			                                                   Registry.Blocks.DEEPSLATE_PALLADIUM_ORE
				                                                   .get()
				                                                   .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldThoriumOres =
			List.of(OreConfiguration.target(stoneReplaceTest,
		                                                                                               Registry.Blocks.THORIUM_ORE
			                                                                                               .get()
			                                                                                               .defaultBlockState()),
		                                                                       OreConfiguration.target(
			                                                                       deepslateReplaceTest,
			                                                                       Registry.Blocks.DEEPSLATE_THORIUM_ORE
				                                                                       .get()
				                                                                       .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldUraniumOres =
			List.of(OreConfiguration.target(stoneReplaceTest,
		                                                                                               Registry.Blocks.URANIUM_ORE
			                                                                                               .get()
			                                                                                               .defaultBlockState()),
		                                                                       OreConfiguration.target(
			                                                                       deepslateReplaceTest,
			                                                                       Registry.Blocks.DEEPSLATE_URANIUM_ORE
				                                                                       .get()
				                                                                       .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldVanadiumOres = List.of(
			OreConfiguration.target(stoneReplaceTest, Registry.Blocks.VANADIUM_ORE
				.get()
				.defaultBlockState()), OreConfiguration.target(deepslateReplaceTest,
			                                                   Registry.Blocks.DEEPSLATE_VANADIUM_ORE
				                                                   .get()
				                                                   .defaultBlockState()));
		
		List<OreConfiguration.TargetBlockState> overworldZincOres = List.of(OreConfiguration.target(stoneReplaceTest,
		                                                                                            Registry.Blocks.ZINC_ORE
			                                                                                            .get()
			                                                                                            .defaultBlockState()),
		                                                                    OreConfiguration.target(
			                                                                    deepslateReplaceTest,
			                                                                    Registry.Blocks.DEEPSLATE_ZINC_ORE
				                                                                    .get()
				                                                                    .defaultBlockState()));
